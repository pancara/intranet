...
import com.integrasolusi.pusda.intranet.dao.filter.*;
 ...
 * Time         : 10:20:20 AM
 */
public class GenericHibernateDaoImpl<T, TId> extends HibernateDaoSupport implements GenericDao<T, TId> {
    ...
    @Override
    public List<T> findByFilter(final Filter filter) {
    ...
    @Override
    public List<T> findByFilter(final Filter filter, final int start, final int count) {
        return (List<T>) getHibernateTemplate().execute(new HibernateCallback() {
            @Override
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                String queryString = String.format("FROM %1$s WHERE %2$s", getPersistentClass().getCanonicalName(), filter.getExpression());
    ...
    @Override
    public List<T> findByFilterOrderBy(final Filter filter, final String orderProperty, final OrderDir orderDir) {
        return (List<T>) getHibernateTemplate().execute(new HibernateCallback() {
            @Override
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
    ...
    @Override
    public List<T> findByFilterOrderBy(final Filter filter, final String orderProperty, final OrderDir orderDir, final int start, final int count) {
        return (List<T>) getHibernateTemplate().execute(new HibernateCallback() {
            @Override
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                String queryString = String.format("FROM %1$s WHERE %2$s ORDER BY %3$s %4$s ",
    ...
    protected void setQueryParameterValues(Query query, Filter filter) {
        ...
        for (Object o : valueFilters) {
            ...
            if (QueryOperator.IS.equals(f.getOperator()) && (f.getValue() == null))
                continue;
    ...
    @Override
    public List<T> findAlls(final int first, final int count) {
        return (List<T>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
    ...
    @Override
    public List<T> findAllsOrderBy(final String orderProperty, final OrderDir orderDir, final int start, final int count) {
        return (List<T>) getHibernateTemplate().execute(
                new HibernateCallback() {
                    public Object doInHibernate(Session session)
                            throws HibernateException, SQLException {
    ...
    @Override
    public List<T> findAllsOrderBy(final String orderProperty, final OrderDir orderDir) {
        return (List<T>) getHibernateTemplate().execute(
                new HibernateCallback() {
                    public Object doInHibernate(Session session)
                            throws HibernateException, SQLException {
    ...
    @Override
    public List<T> findByPropertyOrderBy(final String propertyName, final Object propertyValue,
     ...
     */
    @Override
    public List<T> findByPropertyOrderBy(final String propertyName,
