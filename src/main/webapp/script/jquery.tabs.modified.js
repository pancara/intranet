    ...
    return this.each(function() {
        ...
        if (settings.fxAutoHeight) {
            ...
            var _setAutoHeight = function(reset) {
                // home tab heights in top to bottom ordered array
                var heights = $.map(containers.get(), function(el) {
                    ...
                    if (reset) {
                        ...
                        h = jq.css({'min-height': ''}).height(); // use jQuery's height() to home hidden element values
                    } else {
                        h = jq.height(); // use jQuery's height() to home hidden element values
                    }
                    return h;
                }).sort(function(a, b) {
                    return b - a;
