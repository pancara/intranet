...
(function($) {
    $.fn.piroBox = function(opt) {
        ...
        function start_pirobox() {
            ...
            var piro_close = $(jQuery('<a href="#closeSession" class="piro_close" title="closeSession"></a>'));
            ...
            var load_img = function(my_url) {
                ...
                img.onerror = function () {
                    ...
                    $('.c_c div').append('<p class="err_mess">There seems to be an Error:&nbsp;<a href="#closeSession" class="close_pirobox">Close Pirobox</a></p>');
